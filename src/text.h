...
extern T Text_box(char *str, int len);
...
extern int Text_find  (T s, int i, int j, T pat);
extern int Text_rfind (T s, int i, int j, T pat);
extern int Text_match (T s, int i, int j, T pat);
extern int Text_rmatch(T s, int i, int j, T pat);
extern void Text_cvt(int code, va_list *app,
...
#undef T
#endif
/* $RCSfile: RCS/text.doc,v $ $Revision: 1.2 $ */
